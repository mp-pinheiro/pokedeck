...
[plugin-dev](https://wiki.deckbrew.xyz/en/plugin-dev)
  * /
[route-patching](https://wiki.deckbrew.xyz/en/plugin-dev/route-patching) 

* * *
Route Patching
Using Route Patching to insert new components into the deck UI or edit existing.
* * *
#  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/route-patching#route-patching) Route Patching
...
This guide assumes you've followed the [Getting Started guide](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started) and have your basic plugin template setup.
##  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/route-patching#tldr) TLDR
...
##  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/route-patching#step-by-step-guide) Step by Step guide
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/route-patching#finding-the-route-we-want-to-patch) Finding the route we want to patch
To start we'll need to turn on Remote CEF Debugging in our Decky Settings `Allow Remote CEF Debugging` and then opening `chrome://inspect` on your development machine ([more info on setting up cef debugging](https://wiki.deckbrew.xyz/plugin-dev/cef-debugging)).
...
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/route-patching#patching-the-route) Patching the route
...
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/route-patching#finding-where-we-want-to-make-the-change) Finding where we want to make the change
...
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/route-patching#making-your-changes) Making your changes
