...
[plugin-dev](https://wiki.deckbrew.xyz/en/plugin-dev)
  * /
[env-vars](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars) 

* * *
Environment Variables
Environment Variables Decky provides for as plugins running as subprocesses.
* * *
#  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#environment-variables) Environment Variables
...
---|---|---|---  
`USER` | The username of the effective user running the process.[[1]](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fn1) | v2.5.2-pre1+ |  `root` or `deck`  
~~`USER_ID`~~| ~~The UID of the effective user running the process.[[1:1]](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fn1)~~ | ~~v2.6.3-pre3+~~ | ~~`0`or`1000`~~  
`HOME` | The home directory of the effective user running the process.[[1:2]](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fn1) | v2.5.2-pre1+ |  `/root` or `/home/deck`  
...
---|---|---  
String options  
`PRIVILEGED_PATH` | The root of the decky folder |  `/home/deck/homebrew`[[1:3]](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fn1)  
`UNPRIVILEGED_PATH` | The root of the decky folder |  `/home/deck/homebrew`[[1:4]](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fn1)  
`SERVER_HOST` | The host for decky's server | `127.0.0.1`  
`SERVER_PORT` | Which port decky runs the server on | `1337`  
`LOG_LEVEL` | The level of logging |  `INFO`[[2]](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fn2)  
Boolean Options  
...
* * *
  1. The default values are a little more complex, check the python for more info [↩︎](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fnref1) [↩︎](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fnref1:1) [↩︎](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fnref1:2) [↩︎](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fnref1:3) [↩︎](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fnref1:4)
  2. The valid options are `CRITICAL`, `ERROR`, `WARNING`, `INFO` and `DEBUG` [↩︎](https://wiki.deckbrew.xyz/en/plugin-dev/env-vars#fnref2)
