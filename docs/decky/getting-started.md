...
[plugin-dev](https://wiki.deckbrew.xyz/en/plugin-dev)
  * /
[getting-started](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started) 

* * *
Getting Started
How-To guide about developing a plugin
* * *
#  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#getting-started) Getting Started
...
##  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#plugin-metadata) Plugin Metadata
...
##  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#package-metadata) Package Metadata
...
##  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#frontend) Frontend
...
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#api) API
...
Copy
##  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#backend) Backend
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#python) Python
...
Copy
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#settingsmanager) SettingsManager
...
##  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#other) Other
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#the-defaults-folder) The "defaults" folder
...
###  [¶](https://wiki.deckbrew.xyz/en/plugin-dev/getting-started#pnpm) pnpm
