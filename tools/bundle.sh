...
cp data/species.json data/moves.json data/abilities.json data/abilities_desc.json data/items.json data/items_desc.json data/nat_dex.json data/species_info.json defaults/data/
